...
interface DataContextType {
  ...
  isLoading: boolean;
  addEstudiante: (estudiante: Omit<Estudiante, 'id'>) => Promise<void>;
  addCurso: (curso: Omit<Curso, 'id'>) => Promise<void>;
  addCalificacion: (calificacion: Omit<Calificacion, 'id'>) => Promise<void>;
  ...
  generarReporte: (estudianteId: string, periodo: string) => Promise<ReporteAcademico>;
